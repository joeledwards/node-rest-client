...
exports.Client = function (options){
  ...
  function newRequest(method, url, args, callback) {
    var clientRequest = new ClientRequest();
    Util.connect(method, url, args, callback, clientRequest);
    return clientRequest;
  };

  this.options = function(url, args, callback) {
    return newRequest('OPTIONS', url, args, callback);
  };

  this.head = function(url, args, callback) {
    return newRequest('HEAD', url, args, callback);
  };

	this.get = function(url, args, callback){
    return newRequest('GET', url, args, callback);
	};

	this.post = function(url, args, callback){
    return newRequest('POST', url, args, callback);
	};

	this.put = function(url, args, callback){
    return newRequest('PUT', url, args, callback);
	};

	this.delete = function(url, args, callback){
    return newRequest('DELETE', url, args, callback);
	};

	this.patch = function(url, args, callback){
    return newRequest('PATCH', url, args, callback);
	};
